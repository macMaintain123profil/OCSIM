...
class P2PDemoVC: BaseDemoVC {
    ...
    override func viewDidLoad() {
        ...
        field.attributedPlaceholder = NSAttributedString(string: "请输入68号", attributes: [NSAttributedString.Key.foregroundColor : UIColor.gray])
        ...
        btn.setTitle("添加好友或聊天", for: .normal)
    ...
    @objc func btnClick() {
        ...
        let text = field.text ?? ""
        if text.count == 0 {
            self.view.makeToast("请输入68号", position: .center)
            return
        }
